...
const BenefitSection = () => {
  return (
    <>
    <div className='container md:border rounded-2xl shadow-lg pb-20 h-[100%] flex flex-col gap-5 md:flex-row items-center mt-[7%] justify-center pt-10 '>
        <div className='flex items-center justify-center flex-col'>
            <img className='md:w-[40%] w-[20%] animate-bounce' src={assets.support} alt="" />
        ...
        <div className='flex items-center justify-center flex-col'>
            <img className='md:w-[40%] w-[20%] gap-6 animate-bounce' src={assets.quality} alt="" />
        ...
        <div className='flex items-center justify-center flex-col'>
            <img className='md:w-[40%] w-[20%] animate-bounce' src={assets.paper_flight} alt="" />
